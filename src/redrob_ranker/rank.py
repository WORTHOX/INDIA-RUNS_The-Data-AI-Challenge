"""Turn precomputed feature artifacts into the final top-100 CSV.
...
def run_ranking(
    ...
    *,
    ...
    """Validate artifacts, rank candidates, write CSV, and return the submission frame."""
    ...
    write_submission_csv(submission_frame, output_path)
    return submission_frame


def main() -> None:
    parser = argparse.ArgumentParser(description="Rank candidates into a Redrob submission CSV.")
